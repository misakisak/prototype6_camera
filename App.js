...
export default function App() {
  ...
  const [XrightEyePosition, setXrightEyePosition] = useState(null);
  const [YrightEyePosition, setYrightEyePosition] = useState(null);

  const [XleftEyePosition, setXleftEyePosition] = useState(null);
  const [YleftEyePosition, setYleftEyePosition] = useState(null);
  ...
  const [XrightEarPosition, setXrightEarPosition] = useState(null);
  const [YrightEarPosition, setYrightEarPosition] = useState(null);

  const [XleftEarPosition, setXleftEarPosition] = useState(null);
  const [YleftEarPosition, setYleftEarPosition] = useState(null);
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ flexDirection: 'column'}}>
        ...
        {/* {rightimage && <Image source={{uri: rightimage}} style={{ }}/>} */}
      </View>
